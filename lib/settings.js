...
const settings = {
    ...
    try{
      ...
      try{
        ...
        data = {
          ...
          notification_no_file: true,
          notification_basic_error: true,
        };
  ...
  check: function(){
    if(
      ...
      "notification_unsupported" in this.value &&
      "notification_no_file" in this.value &&
      "notification_basic_error" in this.value
    ){
  ...
  edit_load: function(){
    ...
    var is_unsupported_notification_switch = document.getElementById("settings_unsupported_notification");
    var is_no_file_notification_switch = document.getElementById("settings_no_file_notification");
    var is_basic_error_notification_switch = document.getElementById("settings_basic_error_notification");
    ...
    var is_notification_unsupported = this.value.notification_unsupported;
    var is_notification_no_file = this.value.notification_no_file;
    var is_notification_basic_error = this.value.notification_basic_error;
    ...
    is_unsupported_notification_switch.checked = is_notification_unsupported;
    is_no_file_notification_switch.checked = is_notification_no_file;
    is_basic_error_notification_switch.checked = is_notification_basic_error;
    ...
    if(is_notification_unsupported){
      document.getElementById("settings_switch_label_unsupported_notification").classList.add('is-checked');
    }else{
      document.getElementById("settings_switch_label_unsupported_notification").classList.remove('is-checked');
    }
    if(is_notification_no_file){
      document.getElementById("settings_switch_label_no_file_notification").classList.add('is-checked');
    }else{
      document.getElementById("settings_switch_label_no_file_notification").classList.remove('is-checked');
    }
    if(is_notification_basic_error){
      document.getElementById("settings_switch_label_basic_error_notification").classList.add('is-checked');
    }else{
      document.getElementById("settings_switch_label_basic_error_notification").classList.remove('is-checked');
    }
  ...
  update: function(config){
    ...
    this.value.notification_unsupported = is_unsupported_notification_switch.checked;
    this.value.notification_no_file = is_no_file_notification_switch.checked;
    this.value.notification_basic_error = is_basic_error_notification_switch.checked;
