...
const category = {
  ...
  set_categorys: function(config){
    this.to_json = this.load_category(config);
  ...
  add_new_category: function(config){
    ...
    this.write_categorys_to_file(config);
  ...
  write_categorys_to_file: function(config){
  ...
  update_category: function(config){
  ...
  delete_category: function(config){
    var selected_category_id = document.getElementById("category_select").value;
